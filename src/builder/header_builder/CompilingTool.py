...
class CompilingTool(BuilderInterface):
    ...
    def __init__(self, curr_project_dir: str, source_file: SourceFile, path: str, header_depth: int = DEFAULT_HEADER_DEPTH) -> None:
        self.source_file = source_file
        self.__build_path = path
        self.__file_builder = FileBuilder(curr_project_dir = curr_project_dir, compile_command = self.source_file.compile_command, source_file_name = source_file.get_name(), build_path = path)
