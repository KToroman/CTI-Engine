...
class CommandLineReader:
    ...
    @click.command()
    @click.argument('source_file_name', prompt='Enter a filepath', help='filepath for active measurement')
    ...
    def quit_measurement(self):
        ...
        result = self.app.quit_measurement()
