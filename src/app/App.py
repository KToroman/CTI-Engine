...
from src.fetcher.process_fetcher.Threads.StatusAndErrorThread import StatusAndErrorThread
...
class App(AppRequestsInterface):
    def __init__(self, shutdown_event: Event, passive_mode_event: Event, load_event: Event,
                 load_path_queue: Queue, source_file_name_queue: Queue, visualize_signal: pyqtSignal, error_queue: Queue, error_signal: pyqtSignal, status_signal: pyqtSignal,
